...
for repeat_time in ['1', '2', '3']:
    for model_name in model_size:
        for tissue in tissue_list:
            ...
            image_path = 'images/' + embedding_name + '/sign/shuffled/'
            ...
            with open(image_path + model_name + '_cm-transformer-' + tissue + '(' + task_name + ')_shuffled_' + repeat_time + '.txt', 'w') as file:
            ...
            plt.savefig(image_path + model_name + '_cm-transformer-' + tissue + '(' + task_name + ')_shuffled_' + repeat_time + '.png', dpi=300,
                        bbox_inches='tight')
            ...
            plt.savefig(image_path + model_name + '_auc-transformer-' + tissue + '(' + task_name + ')_shuffled_' + repeat_time + '.png', dpi=300,
                        bbox_inches='tight')
